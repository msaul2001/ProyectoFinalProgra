            ...
            <TouchableOpacity 
                ...
                onPress={() => {
                    ...
                    if (selectedValueI == 1) {
                        ...
                        .then(data => {
                            if(data.Salida == true){
                                console.log("Pago de Deuda Exitoso");
                                navigation.navigate('Home');
                            } else {
                                console.log("ERROR");
                            }
